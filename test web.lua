...
if game.Workspace._WorldOrigin.Locations:FindFirstChild('Kitsune Island') then
    ...
    local url = "https://discord.com/api/webhooks/1286706354043752578/kIA668f2DSaW2zXNgRkvE8JvjqPKQ_qVdV3Jq84LxHb9qpDTl2Hv9H4E5JeTeTVCT4k0"                                                                                                                
    local data = {
        ...
        ["embeds"] = {
            {
                ...
                ["footer"] = {
                    ["text"] = "Webhook Created By DucDesigner", 
                },
                ["timestamp"] = DateTime.now():ToIsoDate(),
            }
        },
